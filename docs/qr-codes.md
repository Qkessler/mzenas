...
```
qrrs -m 2 -o svg "https://mzenas.com/customer-flow/" assets/qr-customer-flow.svg
```
...
It should print `https://mzenas.com/customer-flow/`. If it prints anything else, the SVG was regenerated with the wrong argument and needs to be redone.
